...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { description: @day.description, different: @day.different, exercised: @day.exercised, ill: @day.ill, quality: @day.quality } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { description: @day.description, different: @day.different, exercised: @day.exercised, ill: @day.ill, quality: @day.quality } }
